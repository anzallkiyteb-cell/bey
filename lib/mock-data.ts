...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    zktecoId: "70402802",
    name: "ABDELHAFIDHE",
    email: "abdelhafidhe@gestion.com",
    role: "user",
    department: "Cuisine",
    managerId: "2",
    salary: 1800,
